    ...
    <main className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-[960px] bg-white shadow-[0_4px_32px_rgba(85,164,218,0.15)] border border-gray-100 rounded-sm overflow-hidden">
        ...
        <div className="flex min-h-[380px]">
          ...
          {/* ── 왼쪽 패널 (파란색) ── */}
          <div className="relative flex-[2] min-w-0 bg-brand flex flex-col justify-between px-6 py-8 overflow-hidden">
            {/* 배경 데코 원 */}
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-border rounded-sm text-sm text-text-primary placeholder-placeholder focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand/30 transition bg-surface"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-sm text-sm text-gray-700 placeholder-gray-300 focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand/30 transition bg-white pr-12"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4 border-gray-300 rounded-sm accent-brand cursor-pointer"
                />
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-brand hover:bg-brand-dark disabled:opacity-60 text-white font-bold py-3.5 rounded-sm tracking-[0.15em] text-sm transition-colors duration-200 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
