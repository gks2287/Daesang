  ...
  return (
    <div className="flex flex-col h-full p-6 gap-4">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-[11px] tracking-[0.2em] text-gray-400 font-medium mb-0.5">NEWSLETTERS</p>
          <h1 className="text-xl font-bold text-gray-800">뉴스레터 생성</h1>
        </div>
      ...
      <div className="flex-1 bg-[#D6EAF8] rounded-sm flex items-center justify-center">
        <p className="text-gray-600 text-base font-medium tracking-wide">뉴스레터 목록</p>
      </div>
    </div>
  );
}
