...
const MOCK: Participant[] = [
  ...
  { id: 118, companyId: 1, year: 2026, name: '전준혁', department: '공정기술팀', position: '부장', email: 'jeon.jh@lgchem.com', leadershipType: '독재형', assessmentRound: 1, deliveryStatus: '완료', lastOpenedAt: '2026-05-20', stepCurrent: 5, stepTotal: 5 },
  { id: 119, companyId: 1, year: 2026, name: '노태현', department: '제조팀', position: '차장', email: 'no.th@lgchem.com', leadershipType: '독재형', assessmentRound: 2, deliveryStatus: '열람', lastOpenedAt: '2026-05-16', stepCurrent: 2, stepTotal: 5 },
  { id: 120, companyId: 1, year: 2026, name: '임도윤', department: '경영지원팀', position: '부장', email: 'lim.dy@lgchem.com', leadershipType: '독재형', assessmentRound: 1, deliveryStatus: '열람', lastOpenedAt: '2026-05-14', stepCurrent: 4, stepTotal: 5 },
  { id: 121, companyId: 1, year: 2026, name: '유성재', department: '설비관리팀', position: '차장', email: 'yoo.sj@lgchem.com', leadershipType: '독재형', assessmentRound: 2, deliveryStatus: '발송완료', lastOpenedAt: null, stepCurrent: 1, stepTotal: 5 },
